...
public class WaveView extends View {
     ...
     * 默认波浪1颜色
     */
    private final int WAVE_COLOR1 = Color.parseColor("#1296db");
    /**
     * 默认波浪2颜色
     */
    private final int WAVE_COLOR2 = Color.parseColor("#801296db");
    /**
     * 默认边框颜色
     */
    private final int BORDER_COLOR = Color.parseColor("#1296db");
    /**
     * 默认文字颜色
     */
     ...
     * 形状默认矩形
     */
    private ShowShape mShape = ShowShape.CIRCLE;
    /**
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        int shapeValue = typedArray.getInteger(R.styleable.WaveView_showShape, 1);
        mShape = shapeValue==0?ShowShape.RECT:ShowShape.CIRCLE;
        typedArray.recycle();
    }
